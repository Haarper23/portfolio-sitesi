    ...
    >
      ...
      >
        <div>
          ...
          >
            {featuredProjects.length} projects · scroll to explore
          </p>
        </div>
        <h2
      ...
      >
        {/* Intro slide */}
        <div
          className="flex-shrink-0 w-[35vw] lg:w-[25vw] h-full flex flex-col justify-end pb-20 px-10 lg:px-16"
          style={{ borderRight: "1px solid rgba(245,240,232,0.05)" }}
        >
          <span
            className="font-display font-extrabold leading-none select-none block"
            style={{ fontSize: "10vw", color: "rgba(245,240,232,0.03)" }}
          >
            WORK
          </span>
        </div>
        ...
        {/* End slide */}
        <div
          className="flex-shrink-0 w-[30vw] lg:w-[20vw] h-full flex flex-col items-start justify-end pb-20 px-10"
          style={{ borderRight: "1px solid rgba(245,240,232,0.05)" }}
        >
          <a
            href="#skills"
